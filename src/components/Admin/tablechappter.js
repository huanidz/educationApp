...
const handleDelete = (id)=>{
  axios.delete('https://huy-huan.herokuapp.com/chapter', {
    id: id,
  })
  .then();
}
  ...
  return (
    <TableContainer sx={{ maxHeight: 800 }}>
      <Table style={{ height:'700px' }} sx={{  maxHeight:700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>Mã số chương học</StyledTableCell>

            <StyledTableCell align="right">Tên chương học</StyledTableCell>
            <StyledTableCell align="right">Công cụ</StyledTableCell>
        ...
        <TableBody>
          ...
          {datatb.datatb && datatb.datatb.map((row) => (
            <StyledTableRow key={row.id}>
              ...
              <StyledTableCell align="right">{row.nameChapter}</StyledTableCell>
