...
const handleDelete = (id)=>{
  axios.delete('https://huy-huan.herokuapp.com/course', {
    id: id,
  })
  .then();
}
  ...
  return (
    <TableContainer sx={{ maxHeight: 800 }}>
      <Table style={{ height:'700px' }} sx={{  maxHeight:700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>Mã số khóa học</StyledTableCell>
            <StyledTableCell align="right">ẢNh khóa học</StyledTableCell>
        ...
        <TableBody>
          ...
          {datatb.datatb && datatb.datatb.map((row) => (
            <StyledTableRow key={row.id}>
              ...
              <StyledTableCell align="right"><img src={row.image} height={70} width={100} alt="Logo" /></StyledTableCell>

              <StyledTableCell align="right">{row.nameCourse}</StyledTableCell>
